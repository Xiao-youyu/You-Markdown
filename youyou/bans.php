...
.alert{padding:10px 14px;border-radius:8px;margin-bottom:14px;font-size:.88em;color:
...
.ban-tag.register{background:
.ban-tag.comment{background:
.ban-tag.login{background:
...
.ban-icon-btn.unban{border-color:
.ban-icon-btn.unban:hover{background:
...
.ban-modal-close:hover{background:
...
.ban-capsule .capsule-slider{position:absolute;inset:0;background:
.ban-capsule .capsule-slider:before{content:'';position:absolute;width:22px;height:22px;border-radius:50%;background:
...
.ban-modal-save{flex:1;padding:11px;border:none;border-radius:10px;background:var(--accent);color:
