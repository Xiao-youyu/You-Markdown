...
.version-info{margin-top:12px;padding:12px 16px;background:var(--surface);border:1px solid var(--border);border-radius:var(--radius);display:flex;align-items:center;gap:10px;font-size:.85em;color:var(--text-muted)}
.version-info svg{width:16px;height:16px;stroke:var(--text-muted);fill:none;stroke-width:2;flex-shrink:0}
.version-info .ver-label{color:var(--text-secondary);font-weight:500}
.version-info .ver-num{margin-left:auto;font-family:monospace;font-weight:600;color:var(--accent);font-size:1.05em}
...
<main class="main">
    ...
    <a class="card" href="config.php">
        ...
        <div class="card-info"><div class="card-name">网站配置</div><div class="card-desc">标题、注册限制、评论开关、自动封禁、自定义后台入口</div></div>
        <div class="card-arrow"><svg viewBox="0 0 24 24"><polyline points="9 18 15 12 9 6"/></svg></div>
    </a>
    <a class="card" href="email.php">
        <div class="card-icon" style="background:#e0f2fe;color:#0284c7"><svg viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg></div>
        <div class="card-info"><div class="card-name">邮件配置</div><div class="card-desc">SMTP 配置、异常行为通知、注册邮箱验证</div></div>
        <div class="card-arrow"><svg viewBox="0 0 24 24"><polyline points="9 18 15 12 9 6"/></svg></div>
    </a>
    <a class="card" href="background.php">
        <div class="card-icon" style="background:#f3e8ff;color:#9333ea"><svg viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg></div>
        <div class="card-info"><div class="card-name">网站背景</div><div class="card-desc">自定义背景图片、API 获取、高斯模糊</div></div>
        <div class="card-arrow"><svg viewBox="0 0 24 24"><polyline points="9 18 15 12 9 6"/></svg></div>
    </a>
    <a class="card" href="users.php">
        <div class="card-icon" style="background:#f3e8ff;color:#7c3aed"><svg viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div>
        <div class="card-info"><div class="card-name">用户管理</div><div class="card-desc">查看用户、修改密码邮箱、封禁、禁用</div></div>
        <div class="card-arrow"><svg viewBox="0 0 24 24"><polyline points="9 18 15 12 9 6"/></svg></div>
    </a>
    <a class="card" href="ai_write.php">
        <div class="card-icon" style="background:#fdf4ff;color:#a855f7"><svg viewBox="0 0 24 24"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg></div>
        <div class="card-info"><div class="card-name">AI 写作</div><div class="card-desc">AI 帮你写文章，自动保存到文档目录</div></div>
        <div class="card-arrow"><svg viewBox="0 0 24 24"><polyline points="9 18 15 12 9 6"/></svg></div>
    </a>
    <a class="card" href="logs.php">
        <div class="card-icon orange"><svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg></div>
        <div class="card-info"><div class="card-name">网站日志</div><div class="card-desc">异常行为、越权访问、操作记录</div></div>
        <div class="card-arrow"><svg viewBox="0 0 24 24"><polyline points="9 18 15 12 9 6"/></svg></div>
    </a>
    ...
    <a class="version-info" href="version.php" style="text-decoration:none;cursor:pointer">
        <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>
        <span class="ver-label">网站版本</span>
        <span class="ver-num">v<?= htmlspecialchars(APP_VERSION) ?> ›</span>
    </a>
</main>
<style>
</body>
