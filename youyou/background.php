...
.bg-type-card .type-icon.none{background:
.bg-type-card .type-icon.upload{background:
.bg-type-card .type-icon.api{background:
...
.preview-card-sim .sim-title{font-size:12px;font-weight:600;color:
.preview-card-sim .sim-line{height:4px;background:
.preview-card-sim .sim-line:last-child{width:60%;margin:0 auto}
.preview-overlay{position:absolute;bottom:0;left:0;right:0;padding:10px 12px;background:linear-gradient(transparent,rgba(0,0,0,.5));color:
...
.img-preview-thumb .remove-img{position:absolute;top:4px;right:4px;width:22px;height:22px;border-radius:50%;background:rgba(0,0,0,.6);border:none;color:
